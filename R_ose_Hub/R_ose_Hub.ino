...
struct_message unitsStruct[] = {unit1, unit2, unit3};
...
//  Serial.printf("unit ID %u: %u bytes\n", myData.id, len);
  ...
  unitsStruct[myData.id - 1].moistureLevel = myData.moistureLevel;
  unitsStruct[myData.id - 1].isTooDry = myData.isTooDry;
//
